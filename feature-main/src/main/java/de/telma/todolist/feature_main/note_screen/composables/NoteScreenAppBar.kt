...
fun NoteScreenAppBarModel(
    ...
    val statusString = if (model.isComplete) "Complete" else "In Progress"
...
fun NoteScreenAppBarModel_InProgress_Preview() {
    TodoListTheme {
...
@Composable
@Preview(showBackground = true)
fun NoteScreenAppBarModel_Complete_Preview() {
    TodoListTheme {
        Box(modifier = Modifier.fillMaxWidth().wrapContentHeight()) {
            val model = NoteScreenAppBarModel(
                noteId = 0L,
